  ...
  renderDiv = (i, index) => {
    return (
      <div
        ...
        className={
          this.state.active
            ? `${this.props.imageList[index].orientation} unstack`
            : `${this.props.imageList[index].orientation} stack`
        }
      >
        <img
          ...
          className="image"
          alt=""
          src={this.props.imageList[index].url}
        />
      </div>
    );
  };
          ...
          <Fade duration={2000}>
            <GridLayout
              ...
              className={
                this.state.loaded
                  ? this.state.active
                    ? "layout expanded show"
                    : "layout notexpanded show"
                  : "layout notexpanded hide"
              }
